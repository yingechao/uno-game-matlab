...
cardDeckNonWild=["r1" "r2" "r3" "r4" "r5" "r6" "r7" "r8" "r9" "rs" "rv" "y1" "y2" "y3" "y4" "y5" "y6" "y7" "y8" "y9" "ys" "yv" "b1" "b2" "b3" "b4" "b5" "b6" "b7" "b8" "b9" "bs" "bv" "g1" "g2" "g3" "g4" "g5" "g6" "g7" "g8" "g9" "gs" "gv"];
...
while continueLoop
    ...
    if nextCardPlayed=="p"
        %%%%
        continueLoop=false;
    elseif strfind(cardPlayed(1),nextCardPlayed)>0 %&& ismember(nextCardPlayed,usersCards)>0
        continueLoop=false;
