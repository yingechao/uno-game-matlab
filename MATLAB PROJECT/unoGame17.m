...
r1=imread("red1.png");red2=imread("red2.png");red3=imread("red3.png");red4=imread("red4.png");red5=imread("red5.png");
red6=imread("red6.png");red7=imread("red7.png");red8=imread("red8.png");red9=imread("red9.png");redt=imread("redPlusTwo.png");
reds=imread("redSkip.png");redv=imread("redReverse.png");

yellow1=imread("yellow1.png");yellow2=imread("yellow2.png");yellow3=imread("yellow3.png");yellow4=imread("yellow4.png");
yellow5=imread("yellow5.png");yellow6=imread("yellow6.png");yellow7=imread("yellow7.png");yellow8=imread("yellow8.png");
yellow9=imread("yellow9.png");yellowt=imread("yellowPlusTwo.png");
yellows=imread("yellowSkip.png");yellowv=imread("yellowReverse.png");

blue1=imread("blue1.png");blue2=imread("blue2.png");blue3=imread("blue3.png");blue4=imread("blue4.png");blue5=imread("blue5.png");
blue6=imread("blue6.png");blue7=imread("blue7.png");blue8=imread("blue8.png");blue9=imread("blue9.png");bluet=imread("bluePlusTwo.png");
blues=imread("blueSkip.png");bluev=imread("blueReverse.png");

green1=imread("green1.png");green2=imread("green2.png");green3=imread("green3.png");green4=imread("green4.png");green5=imread("green5.png");
green6=imread("green6.png");green7=imread("green7.png");green8=imread("green8.png");green9=imread("green9.png");greent=imread("greenPlusTwo.png");
greens=imread("greenSkip.png");greenv=imread("greenReverse.png");

CC=imread("colourChange.png");
WW=imread("plusFour.png");

figure('color','#222222')

keySet=["r1" "r2" "r3" "r4" "r5" "r6" "r7" "r8" "r9"];
valueSet=["red1" "red3" "red3" "red4" "red5" "red6" "red7" "red8" "red9"];
d=dictionary(keySet,valueSet);
currentCard=input("Please enter a card. ");
% imshow(currentCard)
subplot(5,9,7), imshow(currentCard)
% 
...
%             if length(cardNumber)==0 %%%%% COULD USE IF LENGTH(PLAYERSCARDS)==0 THEN NO PICK UP AND DO SAME FOR USER 
%                 break
%             end
